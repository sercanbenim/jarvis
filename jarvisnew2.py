    ...
    while True:
        ...
        if 'time' in query:
            ...
            try:
                ...
                reciever = input("Enter recieptant's name: ")
                to = (reciever)
            ...
            api_key = "1164bd464e0a5923c4f550edd764ec2e"
            ...
            try:
                ...
                jsonObj = urlopen('''http://newsapi.org/v2/top-headlines?country=tr&apiKey=79e264eb07f2471592a357a1304c266d''')
                data = json.load(jsonObj)
                i = 1
                
                speak('here are some top news from the times of turkey')
                print('''=============== TOP HEADLINES ============'''+ '\n')
        ...
        #General Questions
            ...
            client = wolframalpha.Client("ERV4RP-6XWH2JAVWT")
